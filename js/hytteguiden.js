...
$(document).ready(function() {
    ...
    if ($("#home_banner_slider").length > 0) {
        ...
        home_banner_slider.noUiSlider.on('update', function(values, handle) {
            ...
            if (handle) {
                $('.banner_max_size').html(parseInt(values[handle]) + 'm <sup>2</sup>');
                $('.banner_in_max_size').val(values[handle]);
            } else {
                $('.banner_min_size').html(parseInt(values[handle]) + 'm <sup>2</sup>');
    ...
    function hytte_reset_range_filter_options(wrapper) {
        ...
        if (wrapper == 'price') {
            ...
            hytteguiden_params.min_price = hytteguiden_params.slider_min_price;
            hytteguiden_params.max_price = hytteguiden_params.slider_max_price;
            ...
            hytteguiden_params.min_size = hytteguiden_params.slider_min_size;
            hytteguiden_params.max_size = hytteguiden_params.slider_max_size;
        } else {
            ...
            hytteguiden_params.min_beds = hytteguiden_params.slider_min_beds;
            hytteguiden_params.max_beds = hytteguiden_params.slider_max_beds;           
        }
...
function filter_results(opt_mode = 'filter') {
    ...
    else if (filter_min_price != hytteguiden_params.min_price || filter_max_price != hytteguiden_params.max_price) {
    ...
    /* Initializing the slider and linking the input For Price Range
    ---------------------------------------------------------  */

var input0 = document.getElementById('filter_min_price');
var input1 = document.getElementById('filter_max_price');
...
inputs.forEach(function (input, handle) {
    ...
    input.addEventListener('change', function () {        
        $('#slide_filter_price')[0].noUiSlider.set([input0.value, input1.value]);
    });
    ...
    /* Initializing the slider and linking the input For Size Range
    ---------------------------------------------------------  */

    var input3 = document.getElementById('filter_min_size');
    var input4 = document.getElementById('filter_max_size');
    var inputsize = [input3, input4];
    
     // Listen to keydown events on the input field.
    inputsize.forEach(function (input, handle) {
    
        input.addEventListener('change', function () {        
            $('#slide_filter_size')[0].noUiSlider.set([input3.value, input4.value]);
        });
    ...
    /* Initializing the slider and linking the input For Bed Range
    ---------------------------------------------------------  */

    var input5 = document.getElementById('filter_min_beds');
    var input6 = document.getElementById('filter_max_beds');
    var inputbed = [input5, input6];
    
     // Listen to keydown events on the input field.
    inputbed.forEach(function (input, handle) {
    
        input.addEventListener('change', function () {        
            $('#slide_filter_beds')[0].noUiSlider.set([input5.value, input6.value]);
        });
