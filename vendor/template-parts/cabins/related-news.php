    <?php
      ...
      $link_post =  get_post_meta(get_the_ID(),'link_post',true);
            ...
            <div class="cabindetails">
              <div class="cabintitle">
                ...
                <div class="row"> 
                  ...
                  <?php 
                    $procuder = get_post_meta($cabin_id,'cabin_producer_id',true);
                    $featured_img_url = get_the_post_thumbnail_url($procuder, 'full');                  
