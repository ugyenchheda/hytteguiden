          ...
          <ul>
              <?php
                ...
                if(isset($producer_website) && !empty($producer_website)){
                  ...
                  <li><a href="'.$producer_website.'" target="_blank">'.$producer_website.'</a></li>';
                  }
                ...
                if(isset($producer_contact_phone_1) && !empty($producer_contact_phone_1)){
                  ...
                  <li><a href="tel:'. hytteguiden_format_phone($producer_contact_phone_1).'" target="_blank">'. hytteguiden_format_phone($producer_contact_phone_1).'</a></li>';
                  }
                ...
                if(isset($producer_email) && !empty($producer_email)){
                  ...
                  <li><a href="mailto:'.$producer_email.'" target="_blank">'.$producer_email.'</a></li>';
                  }
              ?>
          </ul>
