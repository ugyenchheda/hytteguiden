<?php
	...
	$home_banner_title = get_theme_mod('home_banner_title');
	$home_banner_subtitle = get_theme_mod('home_banner_subtitle');
	$home_banner_pretitle = get_theme_mod('home_banner_pretitle');
...
if(isset($home_banner_title) && !empty($home_banner_title)){
		echo '<div class="banner_title_wrap">';

		if(isset($home_banner_pretitle) && !empty($home_banner_pretitle)){
			echo '<p class="pre_title">'. $home_banner_pretitle .'</p>';
		}				
			
		echo '<h2>'. $home_banner_title .'</h2>';


		if(isset($home_banner_subtitle) && !empty($home_banner_subtitle)){
			echo '<p class="sub_title">'. $home_banner_subtitle .'</p>';
		}
