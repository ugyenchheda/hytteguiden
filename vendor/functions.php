...
function hytteguiden_scripts() {
	...
	//wp_enqueue_style( 'all', 'https://use.fontawesome.com/releases/v5.6.3/css/all.css' );
	...
	//wp_enqueue_style( 'hytte-icons', get_template_directory_uri() . '/assets/font/cabinicons.woff?37208266' );
	...
	wp_enqueue_script( 'jquery-3.3.1.min', 'https://code.jquery.com/jquery-3.3.1.min.js', array(), '20190207', true );
	...
	//wp_enqueue_script( 'lazysizes.min', get_template_directory_uri() . '/js/lazysizes.min.js', array(), '20190207', true );
	...
	wp_enqueue_script( 'hytteguiden-custom', get_template_directory_uri() . '/js/custom.js', array(), '201902013', true );
	wp_register_script( 'hytteguiden_script', get_template_directory_uri() . '/js/hytteguiden.js', array(), '20190201334', true );
