...
if ( !class_exists( 'WDS_Taxonomy_Radio' ) ) {
	 ...
	 // Cabin Method
	 $cabin_method = new WDS_Taxonomy_Radio( 'cabin_method' );
	 $cabin_method->priority = 'high';
	 $cabin_method->metabox_title = __( 'Byggemåte', 'hytteguiden' );
	 $cabin_method->force_selection = true;

	 // Cabin Styles
	 $cabin_style = new WDS_Taxonomy_Radio( 'cabin_style' );
	 $cabin_style->metabox_title = __( 'Hytte Stil', 'hytteguiden' );
	 $cabin_style->force_selection = true;

	 // Cabin Type
	 $cabin_type = new WDS_Taxonomy_Radio( 'cabin_type' );
	 $cabin_type->metabox_title = __( 'Tak', 'hytteguiden' );
	 $cabin_type->force_selection = true;
