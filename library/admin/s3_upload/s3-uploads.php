...
/*
Plugin Name: Global Digital S3 Image Upload
Description: Store uploads in Amazon s3
Author: Bijaya Kumar Oli
Version: 1.0.0
Author URI: http://globdig.com
*/



add_action( 'after_setup_theme', 's3_uploads_init' );
